...
hungr is a food discovery app that helps people find food using a personal map, cuisine
preferences, saved places, reviews, photos, friend and community activity, and optional
provenance signals such as self-declared cuisine background or expertise.

This policy is drafted to cover current and planned hungr features. We only collect the
information that applies to the features you use.
...
before making the service available in that region.
...
- We do not sell your personal information. We do not use or share your personal information for
  ...
  notices and choices.
- We use Google Maps, Google Places, and Gemini Grounding to display third-party place information.
  Google content is fetched live through our backend and kept separate from hungr community
  content.
- We store first-party hungr content, such as your saved places, cuisine preferences, reviews,
  photos, tags, follows, and profile information, subject to your settings and deletion rights.
...
- email address;
- authentication identifiers from Supabase Auth, Google sign-in, Apple sign-in, or other login
...
hungr is built around finding food near you. Depending on your device settings and permissions,
we may collect:
...
We use location to show nearby places, recenter the map, search for food near you, reduce
irrelevant results, and prevent abuse or excessive API use.

We do not need background location for the current service. If we ever introduce a feature that
collects background location, we will ask for separate permission and update this policy before
using it.
...
- restaurants, cafes, home food businesses, stalls, or other food places you view, save, tag, or
  review;
...
Depending on the feature and your settings, user-generated content may be visible to other users,
...
settings, or contact us to withdraw consent. Withdrawing consent will not affect processing that
...
We collect technical information needed to operate, secure, improve, and debug the service,
including:
...
- Google Maps, Google Places, and Gemini Grounding, for map, place, review, rating, photo, source
  link, and grounded response display;
...
Third-party place information remains subject to the relevant third party's terms and privacy
policies.
...
We may display Google place names, locations, ratings, review snippets, photos, attributions,
source links, and grounded answers where permitted. We fetch Google content live through our
backend. We do not store Google review text, Google photos, or Google AI summaries in our
database. We may store durable place identifiers, such as Google \`place_id\`, as anchors for
hungr's own first-party data.

hungr community content is separate from Google content. Our own reviews, tags, photos, ratings,
summaries, and recommendations are based on first-party hungr data or content that users,
creators, or partners have permission to provide.

We do not run our own AI models over Google reviews or use Google reviews to infer ethnicity,
heritage, authenticity, expertise, or protected characteristics.
...
- power provenance features, such as showing reviews from users who voluntarily self-identify as
  knowing a cuisine or having a relevant cuisine background;
...
- detect, investigate, and prevent spam, fraud, scraping, abuse, safety issues, and security
  incidents;
...
We do not use automated processing to make decisions that produce legal or similarly significant
...
- **Service providers and processors**, such as Supabase, hosting providers, storage providers,
  analytics providers, crash reporting providers, email providers, customer support tools, security
  vendors, and payment providers if paid features are added.
- **Map, place, auth, and AI providers**, such as Google Maps, Google Places, Gemini, Google
  sign-in, Apple sign-in, and app store providers, where needed to provide the service.
- **Other users**, when you post reviews, photos, tags, profile information, friend activity,
  creator content, or other information that is visible under the relevant feature settings.
- **Creators, restaurants, or partners**, if you interact with partner features, redeem offers,
  make bookings, or choose to share information with them.
- **Professional advisers**, such as lawyers, auditors, accountants, insurers, and security
  consultants.
- **Authorities and legal parties**, if required by law, subpoena, court order, regulator request,
  or to protect rights, safety, security, or property.
- **Business transfer parties**, if we are involved in a merger, acquisition, financing,
  reorganization, bankruptcy, or sale of assets, subject to appropriate confidentiality and privacy
  protections.

We require service providers to process personal information only for permitted purposes and to
...
We do not share personal information for cross-context behavioral advertising or targeted
...
analytics or advertising practice legally counts as "sale", "sharing", or targeted advertising in
your region, we will provide the required notice and opt-out mechanism before using it.
...
Some features may not work without certain information. For example, "food near me" needs a
current or selected location, and provenance ranking needs voluntarily provided provenance signals.
...
account unless we need to retain it for legal, safety, security, fraud-prevention, or legitimate
business reasons. Content you shared with others may remain visible if it has been copied, cached,
aggregated, de-identified, or incorporated into another user's experience, but we will remove or
de-identify it where required by law.
...
No system is perfectly secure. You are responsible for keeping your login methods and devices
secure and for promptly telling us about suspected unauthorized access.

## 12. International transfers

We may process and store personal information in Australia, the United States, and other countries
where we or our service providers operate. Those countries may have privacy laws that differ from
your country.

Where required, we use appropriate transfer safeguards, such as contractual protections,
data-processing agreements, standard contractual clauses, or other lawful transfer mechanisms.

## 13. Children's privacy

hungr is not intended for children under 16. We do not knowingly collect personal information from
children under 16. If you believe a child has provided personal information to us, contact us and
we will take appropriate steps to delete it.

If we ever offer features directed to younger users, we will update this policy and implement
parental consent or other protections required by law.
...
If the Australian Privacy Act 1988 and Australian Privacy Principles apply, this section provides
...
You may have rights to access, correct, delete, restrict, object, portability, withdraw consent,
and complain to a supervisory authority. If we rely on consent, you may withdraw it at any time.

## 17. California and other US state privacy notice

This section applies where US state privacy laws, including the California Consumer Privacy Act
as amended, apply to hungr.
...
We may disclose the categories above to service providers, processors, contractors, app stores,
auth providers, map/place/AI providers, analytics and security providers, professional advisers,
legal authorities, and other users according to your settings and feature choices.

### No sale or sharing

We do not sell personal information or share it for cross-context behavioral advertising. We do
not knowingly sell or share personal information of users under 16.

### Sensitive personal information

We use sensitive personal information only for disclosed service purposes, optional provenance
features you choose, security, legal compliance, and other purposes permitted by law. Where
required, you may direct us to limit use and disclosure of sensitive personal information.

### Rights

Subject to legal limits, California and other eligible US residents may request to know, access,
...
Some browsers send "Do Not Track" signals. There is no common industry standard for responding to
those signals.

Where legally required, we will honor browser-based opt-out preference signals such as Global
Privacy Control for sale, sharing, or targeted advertising. Because we do not currently sell or
share personal information for cross-context behavioral advertising, such signals should not change
the core service experience.

## 19. Communications

We may send service-related messages, such as account, security, privacy, policy, or transactional
notices. You cannot opt out of essential service messages.

We may send marketing or product update messages where permitted. You can unsubscribe using the
instructions in those messages or by contacting us.

## 20. Changes to this policy

We may update this policy from time to time. If changes are material, we will provide notice
through the app, website, email, or another appropriate method. The updated policy will be
effective when posted unless it says otherwise.

If a change materially affects how we use sensitive provenance information, precise location, or
other sensitive information, we will obtain additional consent where required by law.
