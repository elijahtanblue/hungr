...
test("getCommunity reads through safe RPCs and marks the user's own reviews", async () => {
  ...
  await expect(getCommunity("p1")).resolves.toEqual({
    reviews: [
      ...
      { id: "r2", userId: "u2", isMine: false, authorUsername: "jenny", authorName: "Jenny", body: "Someone else's note", rating: 4, upvotes: 0, mineUpvoted: false, createdAt: "2026-06-29T00:00:00Z", edited: false, photos: [] },
    ],
    ratingAverage: 4.5,
    ratingCount: 2,
    tags: ["Hidden gem"],
